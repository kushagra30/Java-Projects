...
//            URL imageUrl = new URL("c://downloads/GameDemo/src/codekamp/images/grass.png");
            ...
            URL play1 = Demo.class.getResource("images/play.png");
    ...
    public void onKeyPress(int keyCode) {
        ...
        if (Demo.playerYCord == 315 && keyCode == 32) {
            Demo.jumpAudio.play();
            Demo.playerYVel = -18;
            Demo.playerYAcc = 1;
        } else {
